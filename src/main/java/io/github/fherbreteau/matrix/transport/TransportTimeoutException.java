...
/**
 * Thrown when a request exceeds the configured request timeout. This is a
 * retryable failure: the request may not have reached the server, or the
 * server may not have answered in time.
 */
