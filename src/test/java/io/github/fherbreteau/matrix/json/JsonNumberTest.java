...
class JsonNumberTest {
  ...
  void preservesBigDecimalPrecision() {
    ...
    assertThat(JsonNumber.of(new BigDecimal("1.25")))
  ...
  void scientificNotationRoundTrips() {
    assertThat(JsonParser.parse("1e100"))
        .extracting(JsonValue::asBigDecimal)
        .isEqualTo(new BigDecimal("1e+100"));
    assertThat(JsonParser.parse("1e100")).extracting(JsonValue::toJson).isEqualTo("1E+100");
    assertThat(JsonParser.parse("123.456e-10"))
        .extracting(JsonValue::asDouble)
        .isEqualTo(123.456e-10);
  }
